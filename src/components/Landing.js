        ...
        return (
            <main ref={el => (this.container = el)}>
                ...
                {/* projectNumber, projectName, projectDescription, githubLink, siteLink */}
                    ...
                    <Card projectImage='pawsibly.png' projectDescription={`Pawsibly is an IOS app made using React Native. It has hand-rolled full authentication, allowing one to save search filters. These filters then allow one to find adoptable pets within their given search parameters, such as: gender, breed, and distance.`} projectDescription2='Technologies Used: React-Native, Expo, CSS, Ruby, Rails, bCrypt.' projectName='Pawsibly' githubLink='https://github.com/pryan-x/Pawsibly' 
                    // siteLink='https://steamreview.surge.sh'
                    />
                     <Card projectImage='richord.png' projectDescription={`This project was worked on in a team of three to create a website with hand-rolled full authentication. With Richord one is able to create a track using the key of C, and then save it to ones personal library of tracks with full playback pause and stop.`} projectDescription2='Technologies Used: React, CSS, Javascript, Express, bCrypt..'projectName='RICHORD' githubLink='https://github.com/ipsita999/RICHORD-APP' siteLink='http://richord.surge.sh/'
                    />
